from .image_convert_to_pdf import DEMO as convert_to_pdf_demo
from .pdf_convert_to_image import DEMO as convert_to_image_demo
from .pdf_read_file import DEMO as read_file_demo
from .pdf_convert_to_word import DEMO as convert_to_word_demo
