from .word_create_new_file import DEMO as create_new_file_demo
from .word_read_file import DEMO as read_file_demo
from .word_write_to_file import DEMO as write_to_file_demo
from .word_convert_to_pdf import DEMO as convert_to_pdf_demo
