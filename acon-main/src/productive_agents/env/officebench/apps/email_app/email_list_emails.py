...
def construct_action(word_dir, args: dict, py_file_path=f'{APPS_ROOT}/email_app/email_list_emails.py'):
    ...
    try:
        ...
        for email_file in email_files:
            with open(email_file, 'rb') as f:
                ...
                emails.append(email)
        message = 'Note: Emails are not listed in any particular order.\n'
