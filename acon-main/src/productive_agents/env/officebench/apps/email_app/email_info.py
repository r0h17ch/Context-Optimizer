from .email_list_emails import DEMO as list_emails_demo
from .email_read_email import DEMO as read_email_demo
from .email_send_email import DEMO as send_email_demo
